...
明るさ・コントラスト・細部の量を、実際にフィルタを通した結果から測り、
ガンマ・コントラスト・シャープネスを計算し直す、を最大5回くり返します。
...
| 指標 | 前（本物 / AI） | 後（本物 / AI） |
| --- | --- | --- |
| 明るさ | 35.8 / 56.7 | 36.1 / 38.3 |
| 黒つぶれ率 | 54.3% / 24.7% | 54.5% / 46.6% |
| 細部 | 6.5 / 4.6 | 5.7 / 5.0 |
| 動き | 10.1 / 8.1 | 9.7 / 8.5 |

残る差は加工ではなく**素材の中身**によるものです（本物には照明の暗い室内劇が含まれ、
AI側は明るい屋外が多い）。さらに詰めるなら、似た明るさ・似た画作りの場面を選んでください。
